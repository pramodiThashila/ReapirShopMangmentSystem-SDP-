...
import { PrinterIcon, RefreshCwIcon, FilterIcon, CalendarIcon, DownloadIcon } from 'lucide-react';
...
interface ReportTotals {
  ...
  totalDistinctItemsBought: number;
...
const PurchaseReport: React.FC = () => {
  ...
  const generateReport = async () => {
    try {
      setLoading(true);
      let url = 'http://localhost:5000/api/report/purchase-report';
      ...
      <div ref={reportRef} className="bg-white shadow-md rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
            <h3 className="text-sm font-medium text-blue-800 uppercase">Total Purchases</h3>
            <p className="text-2xl font-bold text-blue-900 mt-1">{report.totals.totalPurchasesCount}</p>
          </div>
          
          <div className="bg-green-50 p-4 rounded-lg border border-green-100">
            <h3 className="text-sm font-medium text-green-800 uppercase">Total Cost</h3>
            <p className="text-2xl font-bold text-green-900 mt-1">
              {formatCurrency(report.totals.totalPurchaseCost)}
            </p>
          </div>
          
          <div className="bg-purple-50 p-4 rounded-lg border border-purple-100">
            <h3 className="text-sm font-medium text-purple-800 uppercase">No. of Inventory Items Purchased</h3>
            <p className="text-2xl font-bold text-purple-900 mt-1">{report.totals.totalDistinctItemsBought}</p>
          </div>
          
          <div className="bg-amber-50 p-4 rounded-lg border border-amber-100">
            <h3 className="text-sm font-medium text-amber-800 uppercase">Most Purchased Item</h3>
            <p className="text-xl font-bold text-amber-900 mt-1 truncate" title={report.totals.mostPurchasedItem}>
              {report.totals.mostPurchasedItem}
            </p>
          </div>
        </div>
